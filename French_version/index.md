# Portefeuille de Cybersécurité

Bienvenue dans mon **Portefeuille de Cybersécurité**.

Ce dépôt présente mes travaux professionnels et techniques dans le domaine de la cybersécurité, notamment mes projets, certifications et compétences pratiques développées à travers des formations, des travaux académiques et des initiatives personnelles.

Je suis **Lyncold Stephensky CHERY**, passionné par la **sécurité informatique**, **l’analyse de données**, **la gestion des bases de données** et les **technologies innovantes**.
...
- 🎓 Boursier Türkiye Scholarships | Futur étudiant en Master à l’Université Technique d’Istanbul
- 📂 Certifications Google : Cybersécurité & Analyse de données
- 🧠 Centres d’intérêt : Sécurité offensive et défensive, analyse des menaces, Linux, réseaux et veille technologique
...
- [Voir le profil](./profil_professionnel/Profil_profesionnel-Lyncold_Stephensky_CHERY.pdf)
...
- Outils : Aucun  
- [Dossier du projet](./gestion_incident/Ransomware_Incident_Clinic_US_2025/)
- [Le scénario](./gestion_incident/Ransomware_Incident_Clinic_US_2025/Scenario_incident.pdf)
- [Le modèle utilisé](./gestion_incident/Ransomware_Incident_Clinic_US_2025/Modele_de_journal_incident.pdf)
- [Le rapport final](./gestion_incident/Ransomware_Incident_Clinic_US_2025/Rapport_de_reponse_aux_incidents.pdf)
...
- [Dossier du projet](./gestion_incident/L_etude_de_cas_d_incident_d_une_entreprise_multimedia/)
- [Le scénario](./gestion_incident/L_etude_de_cas_d_incident_d_une_entreprise_multimedia/Scenario_d_un_incident_de_cybersecurite.pdf)
- [La réponse à l’incident](./gestion_incident/L_etude_de_cas_d_incident_d_une_entreprise_multimedia/Reponse_a_un_incident_de_cybersecurite.pdf)
...
- [Le scénario](./audit/Botium_Toys/scenario-botium-toys.md)
- [Le rapport d’audit](./audit/Botium_Toys/audit_cybersecurite_de_Botium_Toys_entreprise_fictif.pdf)
- [Mémo pour les parties prenantes](./audit/Botium_Toys/Botium_Toys_memo_pour_les_parties_prenantes.pdf)
...
- [Dossier du projet](./linux_et_sql/linux/)
- [Documentation](./linux_et_sql/linux/Gestion_des_permissions_relatives_des_fichiers_sous_linux.pdf)
...
- [Dossier du projet](./linux_et_sql/linux/Initialiseur_de_projet/)
- [Le scénario](./linux_et_sql/linux/Initialiseur_de_projet/README.md)
- [Script d’automatisation](./linux_et_sql/linux/Initialiseur_de_projet/Initialiseur_de_projet.sh)
- [Script de suppression](./linux_et_sql/linux/Initialiseur_de_projet/supprimer_l_initialiseur_du_projet.sh)
...
- [Dossier du projet](./linux_et_sql/sql/)
- [Requête SQL](./linux_et_sql/sql/appliquer_des_filtres_sql.pdf)
...
### 9. Étude de cas Cyclistic – Analyse de données

> Étude de cas en analyse de données réalisée dans le cadre de ma formation en Data Analytics.
> Ce projet présente le nettoyage des données, l’analyse du comportement des utilisateurs et la visualisation des résultats.

- 🔗 [Dépôt GitHub du projet](https://github.com/Lync97/Cyclistic_Case_Study)
